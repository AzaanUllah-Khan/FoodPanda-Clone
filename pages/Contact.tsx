  ...
  return (
    <div>
      ...
      <section className="relative h-[400px] md:h-[500px]">
        <img 
            src="https://picsum.photos/seed/woman_dog_couch/1920/800" 
            alt="Contact Hero" 
        ...
        <div className="container mx-auto px-4 lg:px-8 relative z-10 h-full flex items-end pb-16 md:pb-24">
            ...
            <div className="flex flex-col md:flex-row gap-12 lg:gap-24">
                ...
                <div className="w-full md:w-1/2 lg:w-7/12 flex items-center justify-center">
                    <div className="relative w-full max-w-lg">
                        <img 
                            src="https://picsum.photos/seed/panda_3d_standing/800/800" 
